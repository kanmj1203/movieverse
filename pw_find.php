            ...
            <div class="login_form_container">  
                <div class="login_form_wrap">
                    ...
                    <div class="login_user_icon_wrap">
                        ...
                        <!-- 입력칸 -->
                        <form class="join_container" action="idpw_find.php" method="post">
                            <div class="login_form_container">
                                    <div class="join_input_container">
                                        <div class="find_page_title">비밀번호 찾기</div>

                                        <div class="find_title">아이디</div>
                                        <div class="join_input_wrap">
                                            <input class="join_input_not_btn find_input" type="text" id="find_pw_id" name="find_pw_id" placeholder="비밀번호를 찾을 아이디를 입력하세요.">
                                        </div>

                                        <div class="find_title">이메일</div>
                                        <div class="join_input_wrap">
                                            <input class="join_input_not_btn find_input" type="text" id="find_pw_email" name="find_pw_email" placeholder="가입 시 사용한 이메일을 입력하세요.">
                                        </div>
