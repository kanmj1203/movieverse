        ...
        <div id='wrap' class="main_container">
            ...
            <div class="login_form_container">  
                <div class="login_form_wrap">
                    ...
                    <!-- 입력칸 -->
                    <form class="join_container" method="post" action="idpw_find.php">
                            <div class="find_page">
                                <div class="join_input_container">
                                    <div class="find_page_title">아이디 찾기</div>
                                    <div class="find_title">이메일</div>
                                    <div class="join_input_wrap">
                                        <input class="join_input_not_btn find_input" type="text" id="find_id_email" name="find_id_email" placeholder="가입 시 사용한 이메일을 입력하세요.">
                                    </div>
                                </div>
                                <div class="find_join">
                                    <p class="find"><a href="pw_find.php">비밀번호 찾기</a> | <a href="member_join.php">회원가입</a></p>
                               </div>
                            </div>  
                         <!-- submit button -->
