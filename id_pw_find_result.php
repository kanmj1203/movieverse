                    ...
                    <!-- 입력칸 -->
                        ...
                        <form class="login_container" action="login.php" method="post">
                            <div class="find_page">
                                <div class="join_input_container">
                                    ...
                                    <div class="login_input_wrap">
                                        ...
                                        <div><input id="id" class="login_input" type="text" name="id" readonly placeholder="<?= $_REQUEST['id'] ?>"/></div>
                                    </div>
                                </div>
                                <div class="find_join">
                         ...
                         <div class="submit_button_text">
                            <a class="next_text_button" href="login.php">로그인</a>
                                 <!-- <input type="button" name="submit" class="next_text_button" value="로그인"></input> -->
                        </div>
                        </form>
                <!-- form END -->
