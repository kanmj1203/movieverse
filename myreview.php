...
// 내 리뷰 전체 가져오기 (최신순)
$review_query = $db->query("select * from review where member_num='$_SESSION[userNum]' order by review_date desc, review_num desc LIMIT $stat, $page_count ");  

// 내 북마크 전체 가져오기 (최신순)
// $bookmark_query = $db->query("select * from bookmark where member_num='$_SESSION[userNum]' order by join_date desc, bookmark_num desc LIMIT $stat, $page_count");  
        ...
        <div id='wrap' class="main_container">
                        ...
                        ?>
                            <div class="my_review_wrap">
                                ...
                                <div class="mypage_review_left">
                                   <div onclick="location.href='choice.php?choice=<?=$row['choice_content']?>&id=<?=$row['content_id']?>';"
                                        class="mypage_review_poster"><img src="<?=$tmdb_img_base_url.$row["poster"]?>"/></div>
                                    </div>
                               
                                <div class="mypage_review_content">
                                    ...
                                    <div>
                                        <button type="button" onclick="location.href='choice.php?choice=<?=$row['choice_content']?>&id=<?=$row['content_id']?>'" class="mypate_review_button">수정하기</button>
                                        <button type="button" onclick="location.href='revew_del.php?choice=<?=$row['choice_content']?>&id=<?=$row['content_id']?>&review_num=<?=$row['review_num']?>'" class="mypate_review_button">삭제하기</button>
                                    </div>
                                </div>
                            </div>
            ...
            <div class="pagination">
                <ul>
                    ...
                    type="button"
                    onclick="location.href='myreview.php?page=<?=$page_prev?>'">
                    <
                    </button></li>
<?php
...
?>
                    ...
                    type="button"
                    onclick="location.href='myreview.php?page=<?=$i?>'"
                    >
                    <?=$i?></button></li>
<?php
                }
?>
                    ...
                    class="pagination_button"
                    type="button"
                    onclick="location.href='myreview.php?page=<?=$page_next?>'" >
                    >
                    </button></li>
            </ul>
            </div>
